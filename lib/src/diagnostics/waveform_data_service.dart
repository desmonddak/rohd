...
/// ## Usage
///
/// The service can be populated by waveform recording integrations.
/// Alternatively, you can manually record value changes:
///
/// ```dart
...
class WaveformDataService {
  ...
  /// deliberately does *not* attach change listeners: legacy waveform dump
  /// integrations attach their own as they write the VCD/FST file. A
  ...
  void _registerServiceExtensions() {
    ...
    unawaited(
      developer.Service.getInfo().then((info) {
        ...
        if (uri != null) {
          // The VM service URI is an intentional command-line status message.
          // ignore: avoid_print
